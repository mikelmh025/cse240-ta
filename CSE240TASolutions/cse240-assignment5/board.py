...
class Snake:
    ...
    def move(self, action):
        ...
        if (self.snake_head_x < helper.GRID_SIZE or self.snake_head_y < helper.GRID_SIZE or self.snake_head_x + helper.GRID_SIZE > helper.DISPLAY_SIZE-helper.GRID_SIZE or self.snake_head_y + helper.GRID_SIZE > helper.DISPLAY_SIZE-helper.GRID_SIZE): 
