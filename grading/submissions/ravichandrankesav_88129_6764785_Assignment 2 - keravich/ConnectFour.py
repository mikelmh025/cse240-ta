...
class Game:
    def __init__(self, player1, player2, time):
        ...
        self.move_string = tk.Label(self.root, text= "Current column selected for move: " + str(self.player_move))
        self.move_string.pack()
    ...
    def on_click(self, event):
        # print("you clicked")
        # print((self.root.winfo_pointerx() - self.root.winfo_rootx())//100)
        self.player_move = (self.root.winfo_pointerx() - self.root.winfo_rootx())//100
        self.move_string.configure(text="Current column selected for move: " + str(self.player_move))
        ...
        if not self.game_over:
            ...
            if current_player.type == 'ai':
                ...
                if self.players[int(not self.current_turn)].type == 'random':
                    ...
                    current_player.evaluation_function(self.board)
